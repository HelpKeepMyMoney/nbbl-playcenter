...
| `functions/index.js` | Callable **`deleteUserAccount`**, **`setUserAdminRole`** (Admin SDK; **`ADMIN_CALLABLE_BASE`**: **`us-central1`**, **`invoker: 'public'`**, **`cors`** allowlist for Vercel + Hosting + localhost) |
