...
| `functions/index.js` | Callable **`deleteUserAccount`**, **`setUserAdminRole`**; Firestore **`notifyAdminClipPendingReview`** (Admin SDK + **Resend**; **`ADMIN_CALLABLE_BASE`**: **`us-central1`**, **`invoker: 'public'`**, **`cors: true`**) |
