...
export default function FanTournamentDetailPage() {
    ...
    return (
      <AppShell title="Tournament">
        <div className="p-8">
          ...
          <Link href="/fan/tournaments" className="text-nbbl-red hover:underline">
            Back to tournaments
          </Link>
        </div>
      </AppShell>
  ...
  return (
    <AppShell
      ...
      breadcrumb={[
        { label: "Tournaments", href: "/fan/tournaments" },
        { label: tournament.title },
      ]}
    >
      <div className="mx-auto max-w-6xl space-y-6 p-4 lg:p-8">
        <Button variant="outline" size="sm" asChild>
          <Link href="/fan/tournaments">
